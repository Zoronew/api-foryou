...
// تأكد من أن بيانات POST تكون مكتوبة بشكل صحيح
router.use(express.json());  // تحليل بيانات JSON
router.use(express.urlencoded({ extended: true }));  // تحليل بيانات URL-encoded
