...
const getTikTokBuffer = async (url) => {
  if (!url) {
    return {
      error: 'لم يتم توفير عنوان URL لـ TikTok',
      message: 'يرجى إدخال عنوان URL صالح لـ TikTok. مثال: ' +
        'https://www.tiktok.com/@kidzuna._/video/7362555646824238344?is_from_webapp=1&sender_device=pc&web_id=7367511669172127238'
    };
  }
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          return {
            error: 'خطأ داخلي في واجهات برمجة التطبيقات',
            message: 'لم يتم العثور على نتائج. الرجاء معاودة المحاولة في وقت لاحق.'
          };
        }
      }
    }
