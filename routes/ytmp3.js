...
// دالة لتحويل رابط فيديو يوتيوب إلى رابط تحميل MP3 باستخدام axios و cheerio
...
// راوتر لتحميل الفيديوهات كملفات MP3
router.get('/', async (req, res) => {
  ...
  try {
    ...
    const outputPath = `./tmp/${titulo.replace(/[^a-zA-Z0-9]/g, '_')}_${Date.now()}.mp3`;

    // تحميل الملف باستخدام الرابط الذي تم استرداده
    ...
    let fileName = `${titulo.replace(/[^a-zA-Z0-9]/g, '_')}_${Date.now()}.mp3`;
    let fileIndex = 1;
